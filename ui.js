            ...
            <div class="col-md-8">
                ...
                <li class="list-group">
                    <li class="list-group-item borderzero">
                        <img src="images/company.png" width="30px" alt=""> <span id="company">${user.company}</span>
                    </li>
                    <li class="list-group-item borderzero">
                        <img src="images/location.png" width="30px" alt=""> <span id="location">${user.location}</span>

                    </li>
                    <li class="list-group-item borderzero">
                        <img src="images/mail.png" width="30px" alt=""> <span id="mail">${user.email}</span>
